...
list.Set( "simfphys_vehicles", "sim_fphys_diablo", V )
...
list.Set( "simfphys_vehicles", "sim_fphys_civic", V )
...
local V = {
	Name = "Bugatti Bolide",
	Model = "models/sim_fphys_bug_bolide/bug_bolide.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = Category,
	SpawnOffset = Vector(0,0,0),
	SpawnAngleOffset = 90,
	...
	Members = {
		...
		CustomWheelModel = "models/sim_fphys_bug_bolide/bug_bolide_wheel.mdl",
		CustomWheelPosFL = Vector(32, -52.0, 15)*1.3,
		CustomWheelPosFR = Vector(31, 56.13, 15.15)*1.3,
		CustomWheelPosRL = Vector(-32, -52.0, 15)*1.3,
		CustomWheelPosRR = Vector(-31, 56.13, 15.15)*1.3,
		CustomWheelAngleOffset = Angle(0,-90,0),
		FrontWheelRadius = 16,
		RearWheelRadius = 16,
		BulletProofTires = true,
		
		CustomMassCenter = Vector(0,5,-1), 
		
		CustomSteerAngle = 20,
		
		SeatOffset = Vector(0,-22.5,40),
		SeatPitch = 0,
		SeatYaw = 0,
...
list.Set( "simfphys_vehicles", "sim_fphys_bolide", V )
...
list.Set( "simfphys_vehicles", "sim_fphys_wrx", V )
...
list.Set( "simfphys_vehicles", "sim_fphys_beck", V )
